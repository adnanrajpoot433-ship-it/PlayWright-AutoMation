...
Received value: {"booking": {"additionalneeds": "Breakfast", "bookingdates": {"checkin": "2018-01-01", "checkout": "2019-01-01"}, "depositpaid": true, "firstname": "Jim", "lastname": "Adnan bashir", "totalprice": 111}, "bookingid": 112}
```
...
> 51 |        expect(responseBody).toHaveProperty("additionalneeds");
     |                             ^ Error: expect(received).toHaveProperty(path)
  52 | 
